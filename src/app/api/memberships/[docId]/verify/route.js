...
// POST /api/memberships/[membershipId]/documents/[docId]/verify
export async function POST(req, { params }) {
  ...
  // Only active manager of that house can verify
  ...
  // Only allow access while membership is active
  ...
  doc.verified = !doc.verified; // toggle
  if (doc.verified) {
...
// DELETE /api/memberships/[membershipId]/documents/[docId]/verify  (delete doc)
